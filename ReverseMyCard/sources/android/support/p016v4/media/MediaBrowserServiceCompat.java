...
import android.support.p016v4.media.MediaBrowserCompat;
import android.support.p016v4.media.MediaBrowserServiceCompatApi21;
import android.support.p016v4.media.MediaBrowserServiceCompatApi23;
import android.support.p016v4.media.MediaBrowserServiceCompatApi24;
...
import android.support.p016v4.util.Pair;
...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle) {
        ...
        final String str2 = str;
        final Bundle bundle2 = bundle;
        C04271 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list, int i) {
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C04282 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem, int i) {
                if ((i & 2) != 0) {
