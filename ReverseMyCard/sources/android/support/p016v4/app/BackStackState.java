...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        int i = 0;
        for (BackStackRecord.C0388Op op = backStackRecord.mHead; op != null; op = op.next) {
            if (op.removed != null) {
                i += op.removed.size();
            }
        }
        ...
        int i2 = 0;
        for (BackStackRecord.C0388Op op2 = backStackRecord.mHead; op2 != null; op2 = op2.next) {
            int i3 = i2 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i2 < this.mOps.length) {
            BackStackRecord.C0388Op op = new BackStackRecord.C0388Op();
            int i3 = i2 + 1;
            op.cmd = this.mOps[i2];
