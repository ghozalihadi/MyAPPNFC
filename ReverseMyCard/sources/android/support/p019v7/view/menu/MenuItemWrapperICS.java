...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public ActionProvider getActionProvider() {
        android.support.p016v4.view.ActionProvider supportActionProvider = ((SupportMenuItem) this.mWrappedObject).getSupportActionProvider();
    ...
    class ActionProviderWrapper extends android.support.p016v4.view.ActionProvider {
    ...
    static class CollapsibleActionViewWrapper extends FrameLayout implements android.support.p019v7.view.CollapsibleActionView {
