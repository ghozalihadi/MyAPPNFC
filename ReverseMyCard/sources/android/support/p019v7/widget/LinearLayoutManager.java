...
import android.support.p019v7.widget.helper.ItemTouchHelper;
...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider, ItemTouchHelper.ViewDropHandler {
    ...
    /* access modifiers changed from: package-private */
    public int gatherPrefetchIndicesForLayoutState(RecyclerView.State state, LayoutState layoutState, int[] iArr) {
