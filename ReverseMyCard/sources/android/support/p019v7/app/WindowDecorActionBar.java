...
import android.support.p016v4.view.ViewPropertyAnimatorListener;
import android.support.p016v4.view.ViewPropertyAnimatorListenerAdapter;
import android.support.p016v4.view.ViewPropertyAnimatorUpdateListener;
...
import android.support.p019v7.view.ActionBarPolicy;
import android.support.p019v7.view.ActionMode;
import android.support.p019v7.view.SupportMenuInflater;
import android.support.p019v7.view.ViewPropertyAnimatorCompatSet;
import android.support.p019v7.view.menu.MenuBuilder;
import android.support.p019v7.view.menu.MenuPopupHelper;
import android.support.p019v7.view.menu.SubMenuBuilder;
import android.support.p019v7.widget.ActionBarContainer;
import android.support.p019v7.widget.ActionBarContextView;
import android.support.p019v7.widget.ActionBarOverlayLayout;
import android.support.p019v7.widget.DecorToolbar;
import android.support.p019v7.widget.ScrollingTabContainerView;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0555R.C0557id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0555R.C0557id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0555R.C0557id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0555R.C0557id.action_bar_container);
        ...
        if (obtainStyledAttributes.getBoolean(C0555R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0555R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0555R.attr.actionBarWidgetTheme, typedValue, true);
