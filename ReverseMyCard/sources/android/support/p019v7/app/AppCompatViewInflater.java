...
import android.support.p019v7.widget.AppCompatAutoCompleteTextView;
import android.support.p019v7.widget.AppCompatButton;
import android.support.p019v7.widget.AppCompatCheckBox;
import android.support.p019v7.widget.AppCompatCheckedTextView;
import android.support.p019v7.widget.AppCompatEditText;
import android.support.p019v7.widget.AppCompatImageButton;
import android.support.p019v7.widget.AppCompatImageView;
import android.support.p019v7.widget.AppCompatMultiAutoCompleteTextView;
import android.support.p019v7.widget.AppCompatRadioButton;
import android.support.p019v7.widget.AppCompatRatingBar;
import android.support.p019v7.widget.AppCompatSeekBar;
import android.support.p019v7.widget.AppCompatSpinner;
import android.support.p019v7.widget.AppCompatTextView;
import android.support.p019v7.widget.TintContextWrapper;
...
class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        int i;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0555R.styleable.View, 0, 0);
        if (z) {
            i = obtainStyledAttributes.getResourceId(C0555R.styleable.View_android_theme, 0);
        } else {
            i = 0;
        }
        if (z2 && i == 0 && (i = obtainStyledAttributes.getResourceId(C0555R.styleable.View_theme, 0)) != 0) {
