...
import android.support.p016v4.widget.NestedScrollView;
...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0555R.styleable.AlertDialog, C0555R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0555R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0555R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0555R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0555R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0555R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0555R.styleable.AlertDialog_listItemLayout, 0);
    ...
    private void setupView() {
        ...
        int i;
        View findViewById;
        View findViewById2 = this.mWindow.findViewById(C0555R.C0557id.parentPanel);
        View findViewById3 = findViewById2.findViewById(C0555R.C0557id.topPanel);
        View findViewById4 = findViewById2.findViewById(C0555R.C0557id.contentPanel);
        View findViewById5 = findViewById2.findViewById(C0555R.C0557id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById2.findViewById(C0555R.C0557id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById6 = viewGroup.findViewById(C0555R.C0557id.topPanel);
        View findViewById7 = viewGroup.findViewById(C0555R.C0557id.contentPanel);
        View findViewById8 = viewGroup.findViewById(C0555R.C0557id.buttonPanel);
        ...
        if (!(z2 || resolvePanel2 == null || (findViewById = resolvePanel2.findViewById(C0555R.C0557id.textSpacerNoButtons)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        final View findViewById = this.mWindow.findViewById(C0555R.C0557id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0555R.C0557id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0555R.C0557id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0555R.C0557id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if (!TextUtils.isEmpty(this.mTitle)) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0555R.C0557id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0555R.C0557id.scrollView);
