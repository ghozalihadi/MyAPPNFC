package android.support.p019v7.util;
...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new Comparator<Snake>() {
        public int compare(Snake snake, Snake snake2) {
            int i = snake.f1225x - snake2.f1225x;
            return i == 0 ? snake.f1226y - snake2.f1226y : i;
        }
    };
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f1225x += range.oldListStart;
                diffPartial.f1226y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (diffPartial.reverse) {
                    range2.oldListEnd = diffPartial.f1225x;
                    range2.newListEnd = diffPartial.f1226y;
                } else if (diffPartial.removal) {
                    range2.oldListEnd = diffPartial.f1225x - 1;
                    range2.newListEnd = diffPartial.f1226y;
                } else {
                    range2.oldListEnd = diffPartial.f1225x;
                    range2.newListEnd = diffPartial.f1226y - 1;
                }
                arrayList2.add(range2);
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f1225x + diffPartial.size;
                    range.newListStart = diffPartial.f1226y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = diffPartial.f1225x + diffPartial.size + 1;
                    range.newListStart = diffPartial.f1226y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f1225x + diffPartial.size;
                    range.newListStart = diffPartial.f1226y + diffPartial.size + 1;
                }
        ...
        for (int i12 = 0; i12 <= i11; i12++) {
            ...
            while (i13 <= i12) {
                ...
                if (!z3 || i13 < (i10 - i12) + 1 || i13 > (i10 + i12) - 1 || iArr[i5 + i13] < iArr2[i5 + i13]) {
                    ...
                    snake.f1225x = iArr2[i5 + i13];
                    snake.f1226y = snake.f1225x - i13;
            ...
            while (i16 <= i12) {
                ...
                if (z3 || i16 + i10 < (-i12) || i16 + i10 > i12 || iArr[i5 + i17] < iArr2[i5 + i17]) {
                    ...
                    snake2.f1225x = iArr2[i5 + i17];
                    snake2.f1226y = snake2.f1225x - i17;
    ...
    public static class DiffResult {
        ...
        private void addRootSnake() {
            ...
            if (snake == null || snake.f1225x != 0 || snake.f1226y != 0) {
                Snake snake2 = new Snake();
                snake2.f1225x = 0;
                snake2.f1226y = 0;
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f1225x + snake.size;
                int i4 = snake.f1226y + snake.size;
                ...
                for (int i5 = 0; i5 < snake.size; i5++) {
                    int i6 = snake.f1225x + i5;
                    int i7 = snake.f1226y + i5;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i9 = snake.f1225x + snake.size;
                int i10 = snake.f1226y + snake.size;
                if (z) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            while (size >= 0) {
                Snake snake = this.mSnakes.get(size);
                int i4 = snake.size;
                int i5 = snake.f1225x + i4;
                int i6 = snake.f1226y + i4;
                if (i5 < i) {
                ...
                for (int i7 = i4 - 1; i7 >= 0; i7--) {
                    if ((this.mOldItemStatuses[snake.f1225x + i7] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f1225x + i7, 1, this.mCallback.getChangePayload(snake.f1225x + i7, snake.f1226y + i7));
                    }
                }
                i = snake.f1225x;
                size--;
